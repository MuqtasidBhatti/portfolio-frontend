...
const AddProject = () => {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Failed to create project. Try again.')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="min-h-screen bg-black px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <h2 className="text-white text-4xl font-bold mb-1">Create Project</h2>
        ...
        <div className="bg-[#0d0d0d] border border-[#1f1f1f] rounded-lg p-8 space-y-5">
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            <span className="text-gray-400 text-sm">Publish immediately</span>
          </label>
        </div>
